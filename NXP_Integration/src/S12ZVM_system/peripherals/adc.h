...
// Select usage of ADC0 to measure the DC-bus current. 
#define USE_ADC0_FOR_CURRENT
// It can be switched to the ADC1
#ifndef USE_ADC0_FOR_CURRENT
	#define USE_ADC1_FOR_CURRENT
#endif
