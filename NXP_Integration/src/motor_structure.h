...
typedef struct
{
	...
	tFrac16					iQUpperLimit;
	tFrac16					iQLowerLimit;
	GFLIB_LIMIT_T_F16		dutyCycleLimit;
}sensorLessPospe_t;
...
typedef struct{
    ...
    AMCLIB_CURRENT_LOOP_T_F16		currentLoop;	// dq - axis required currents and PI controllers settings
    ...
    tFrac16							iCLoop_Limit;	// Current loop limit
    ...
    */
    AMCLIB_SPEED_LOOP_T_F16 		speedLoop;		// Speed loop control parameters
