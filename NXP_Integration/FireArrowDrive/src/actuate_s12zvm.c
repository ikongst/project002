...
//	}
	...
	switch (sector) {
		...
		case 2:
            ...
            first=diffUV;//pwmB.f16Arg2;
			second=diffWU;//pwmB.f16Arg1;
		...
		case 3:
            ...
            first=diffVW;//pwmB.f16Arg2;
			second=diffWU;//pwmB.f16Arg3;
		...
		case 4:
            ...
            first=diffVW;//pwmB.f16Arg3;
			second=diffUV;//pwmB.f16Arg2;
		...
		case 5:
            ...
            first=diffWU;//pwmB.f16Arg3;
			second=diffUV;//pwmB.f16Arg1;
		...
		case 6:
            ...
            first=diffWU;//pwmB.f16Arg1;
			second=diffVW;//pwmB.f16Arg3;
