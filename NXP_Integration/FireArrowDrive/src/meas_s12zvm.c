	...
	*/
	rmsadd+=(Ifirst*first+Isecond*second)/unitdev;
	   ...
	   if(++Iadd>=100)
		{
		 rms=rmsadd/10;
		 MotorDrive_uiCurrent=rms;  ///40;
		 //l_u8_wr_LIN_NXP_ActCurrent(MotorDrive_uiCurrent);//refresh current
		 Iadd=0;
		 rmsadd=0;
		}
...
void GetAdcRawValues(measModule_t *ptr, ADC_RAW_DATA_T *rawData)
{
	...
	//readFromList ^= (1 << 0);
	/* removing DC shift of 2.5V ~ OX7FFF */
	rawData->ph1.f16Arg1 = (tFrac16)(ADC1ResultList[readFromList][0]) - (tFrac16)0x7FFF - (tFrac16)ptr->offset.f16Idcb.f16Offset;
	rawData->ph2.f16Arg1 = (tFrac16)( ADC1ResultList[readFromList][1]) - (tFrac16)0x7FFF - (tFrac16)ptr->offset.f16Idcb.f16Offset;
	rawData->dcOffset = 0;
	//((tFrac32)(ADC1ResultList[readFromList][2]) - (tFrac32)0x7FFF)<<16;
	rawData->ph2.f16Arg2 = (tFrac16)(ADC1ResultList[readFromList][2]) - (tFrac16)0x7FFF - (tFrac16)ptr->offset.f16Idcb.f16Offset;
	rawData->ph1.f16Arg2 = (tFrac16)(ADC1ResultList[readFromList][3]) - (tFrac16)0x7FFF - (tFrac16)ptr->offset.f16Idcb.f16Offset;
}
#endif
...
unsigned int NTC_table[3]={2159,700,3333};   //mid ad , mid temp , B number x-3455-3380-y?
...
//		
	...
	//ptr->measured.f16NTC.filt = ptr->measured.f16NTC.filt>>2;
	return(1);
}
