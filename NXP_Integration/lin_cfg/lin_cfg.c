...
* @version   1.0
*
* @date      Mon Jul 03 17:23:35 CST 2023
*
...
const l_signal_handle LIN_NXP_response_error_signal = LIN_NXP_RespErr;
const l_u8 response_error_byte_offset = LIN_BYTE_OFFSET_LIN_NXP_RespErr;
const l_u8 response_error_bit_offset = LIN_BIT_OFFSET_LIN_NXP_RespErr;
...
l_u8    lin_pFrameBuf[LIN_FRAME_BUF_SIZE] =
{
  ...
  0xff /* 0 : 11111111 */ /* start of frame LIN_NXP_MotorCtrl */
  ...
  ,0x00 /* 8 : 00000000 */ /* start of frame LIN_NXP_MotorStatus */
  ...
  ,0x00 /* 16 : 00000000 */ /* start of frame LIN_NXP_SystemStatus */
...
l_u8    lin_flag_handle_tbl[LIN_FLAG_BUF_SIZE] =
{
  ...
  0x00 /* 0: start of flag frame LIN_NXP_MotorCtrl */



  ,0x00 /* 1: start of flag frame LIN_NXP_MotorStatus */

  ,0x00 /* 2: */
  

  ,0x00 /* 3: start of flag frame LIN_NXP_SystemStatus */
...
const lin_frame_struct lin_frame_tbl[LIN_NUM_OF_FRMS] ={
   ...
   ,{ LIN_FRM_UNCD, 8, LIN_RES_PUB, 8, 1, 2 , (l_u8*)&LIN_NXP_response_error_signal }
  
   ,{ LIN_FRM_UNCD, 8, LIN_RES_PUB, 16, 3, 2 , (l_u8*)0 }
...
l_u8 lin_configuration_RAM[LIN_SIZE_OF_CFG]= {0x00, 0x11, 0x12, 0x13, 0x3C, 0x3D ,0xFF};
const l_u16  lin_configuration_ROM[LIN_SIZE_OF_CFG]= {0x00, 0x11, 0x12, 0x13, 0x3C, 0x3D ,0xFFFF};

/***************************************** Node Attribute*****************************************/

l_u8 lin_configured_NAD = 0x01;    /*<configured_NAD>*/
const l_u8 lin_initial_NAD    =0x01;    /*<initial_NAD>*/
const lin_product_id product_id = {0x1234, 0x5678, 0x0000 };  /* {<supplier_id>,<function_id>,<variant>} */
const l_signal_handle response_error =  LIN_NXP_RespErr;
...
const l_u8 lin_diag_services_supported[_DIAG_NUMBER_OF_SERVICES_] = {0xB2,0xB6,0xB7,0x22,0x10,0x2F,0x19,0x14,0xB1};
