...
/*************************************************************/
l_u16 Ref_speed;
unsigned int App_count=0,App_temp=0;
unsigned int dutytt=6;
...
//	
//	//DisableOutput();
//    //Meas_CalibCurrentSense(&meas, drvFOC.svmSector);
//	
//	while(1)
//	{
//		__RESET_WATCHDOG();
//		//meas.offset.f16Idcb.f16Offset=-8244;//24800;
//		if(App_count!=App_temp)
//		{
//		 App_count=App_temp;
//		 Set_Bridge_DutyCycle(dutytt,0,0); 
//		}		
//			
//	}
...
//	//--------------------------------------------
	...
	// temp = (150*dVHT -(VHT(150)-VHT(temp) ))/dVHT;
	// temp = (5.25mV/C*150 - (2.4 - (meas.measured.f16Temp.raw>>4)*5/4096))/5.25
	// temp = 150-  (2.4-(meas.measured.f16Temp.raw)*5>>16))/5.25
...
void stateRun( )
{
    ...
    //(MLIB_Abs_F16(drvFOC.pospeOpenLoop.wRotEl)*3000)>>15;  //add for El. speed output
